...
<head>
  ...
  <title>{{ $metaTitle ?? 'Blog - Teman Remaja' }}</title>
  <meta name="description" content="{{ $metaDescription ?? 'Daftar artikel kesehatan dan edukasi terbaru dari Teman Remaja' }}" />
  ...
  <header class="fixed top-0 w-full z-40 bg-white shadow">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      <div class="text-2xl font-bold text-pink-500">
        <a href="/">Teman<span class="text-gray-700">Remaja</span></a>
      </div>
      <!-- Desktop Menu -->
